...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Objective of this is to create a python program which applies the maths and physics knowledge that I have learnt from school/college and implement them in a python project
